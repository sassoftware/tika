...
• **Branch 1.28.5-CVE-2025-66516-CVE-2025-54988**: CVE fixes implemented for Tika 1.28.5 base  
...
**For users requiring Java 8 compatibility or 1.x API compatibility**

This branch provides CVE fixes implemented on Tika 1.28.5 base:
- Same security fixes as 3.2.2
- Java 8 compatible
- No breaking API changes from 1.x
...
- **Upgrade to 3.2.2 or this branch that includes CVE fixes for 1.28.5 is MANDATORY**
...
- **Status:** All tests pass on this branch (3.2.2 and 1.28.5 CVE fixes)
...
### Key Changes in Branch 1.28.5-CVE-2025-66516-CVE-2025-54988
...
Branch 1.28.5-CVE-2025-66516-CVE-2025-54988 includes comprehensive security tests in `XMLReaderUtilsTest.java`:
...
**Note:** Requires Java 11+ and may include API changes from 1.x versions.

---

### For Users Running Tika 1.x Who Cannot Upgrade to 3.x

If you cannot upgrade to 3.2.2 due to:
- Java version constraints (still using Java 8)
- Breaking API changes between 1.x and 3.x
- Legacy application dependencies
- Extensive testing requirements

#### Option 2: Use Branch 1.28.5-CVE-2025-66516-CVE-2025-54988 (CVE Fixes for 1.28.5)

**Why Choose Branch 1.28.5-CVE-2025-66516-CVE-2025-54988:**
- Same CVE fixes as 3.2.2, adapted for 1.28.5
...
wget https://github.com/sassoftware/tika/releases/download/1.28.5-CVE-2025-66516-CVE-2025-54988/tika-app-1.28.5.jar
wget https://github.com/sassoftware/tika/releases/download/1.28.5-CVE-2025-66516-CVE-2025-54988/tika-core-1.28.5.jar
```

**Option B: Build from Source**
```bash
# Clone branch 1.28.5-CVE-2025-66516-CVE-2025-54988
git clone -b 1.28.5-CVE-2025-66516-CVE-2025-54988 https://github.com/sassoftware/tika.git
cd tika/repo
...
# The version will be 1.28.5 with CVE fixes
```
...
- Maintains compatibility with existing 1.x applications
...
1. **Primary Defense: Upgrade to 3.2.2 or This Branch That Includes CVE Fixes for 1.28.5 (MANDATORY)**
   - Upgrade to Tika 3.2.2 (requires Java 11+, receives future Apache security updates)
   - OR use this branch that includes CVE fixes for 1.28.5 (Java 8 compatible, requires manual tracking of future Apache patches)
...
This branch remediates CVE-2025-66516 and CVE-2025-54988 for Apache Tika 1.28.5.

• **Repository:** https://github.com/sassoftware/tika  
• **Branch:** 1.28.5-CVE-2025-66516-CVE-2025-54988    
