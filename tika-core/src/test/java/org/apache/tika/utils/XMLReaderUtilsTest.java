...
public class XMLReaderUtilsTest {
    ...
    public void testCVE_2025_54988_GetTransformerExists() throws Exception {
        ...
        assertNotNull("getTransformer() should return a Transformer", transformer);
    ...
    public void testCVE_2025_54988_GetTransformerBlocksXXE() throws Exception {
        ...
        try {
            ...
            assertFalse("CVE-2025-54988: TransformerFactory must not expand external entities or leak file contents", result.contains("root:") || result.contains("daemon:"));
                
        } catch (Exception e) {
            // Expected - external entity should be blocked
            String msg = e.getMessage();
            assertTrue("CVE-2025-54988: TransformerFactory XXE protection failed, got: " + msg, msg != null && (msg.contains("Entity") || msg.contains("not allowed") || msg.contains("external")));
        }
    }
    ...
    public void testCVE_2025_66516_XMLStreamReaderXXEBlocked() throws Exception {
        ...
        try {
            ...
            assertFalse("CVE-2025-66516: XMLStreamReader must not expand external entities or leak file contents", result.contains("root:"));
        } catch (Exception e) {
            // Expected - entity should be blocked
            String msg = e.getMessage();
            assertTrue("CVE-2025-66516: XMLInputFactory XXE protection failed, got: " + msg, msg != null && (msg.contains("entity") || msg.contains("DTD") || msg.contains("not declared")));
        }
    }
    ...
    public void testCVE_2025_66516_BillionLaughsAttackBlocked() throws Exception {
        ...
        try {
            ...
            assertTrue("CVE-2025-66516: Billion Laughs attack must complete quickly without entity expansion", elapsed < 1000);
            
        } catch (Exception e) {
            // Acceptable - entity expansion should be blocked
            String msg = e.getMessage();
            assertTrue("CVE-2025-66516: Entity expansion protection failed (Billion Laughs attack), got: " + msg, msg != null && (msg.contains("entity") || msg.contains("DTD") || msg.contains("not declared")));
        }
    }
    ...
    public void testCVE_2025_66516_ParameterEntityBlocked() throws Exception {
        ...
        try {
            ...
            // Expected
            String msg = e.getMessage();
            assertTrue("CVE-2025-66516: Parameter entity protection failed, got: " + msg, msg != null && (msg.contains("entity") || msg.contains("DTD") || msg.contains("not declared")));
        }
    }
    ...
    public void testCVE_2025_66516_XIncludeBlocked() throws Exception {
        ...
        try {
            ...
            String result = content.toString();
            assertFalse("CVE-2025-66516: XInclude attack must not leak file contents", result.contains("root:"));
    ...
    public void testCVE_2025_66516_PublicDoctypeBlocked() throws Exception {
        try {
            ...
            String msg = e.getMessage();
            assertTrue("CVE-2025-66516: SAX parser XXE protection failed (PUBLIC DOCTYPE attack), got: " + msg, msg != null && (msg.contains("Entity") || msg.contains("DTD") || msg.contains("not allowed") || msg.contains("external")));
        }
    }
    ...
    public void testCVE_2025_66516_XMLLogReaderPattern() throws Exception {
        ...
        try {
            ...
            assertFalse("CVE-2025-66516: Utility class XMLLogReader pattern must not leak file contents via XXE", result.contains("root:") || result.contains("daemon:"));
        } catch (Exception e) {
            // Expected - XXE should be blocked
            String msg = e.getMessage();
            assertTrue("CVE-2025-66516: XXE protection failed in utility class pattern, got: " + msg, msg != null && (msg.contains("entity") || msg.contains("DTD") || msg.contains("not declared")));
        }
    }
    ...
    public void testCVE_2025_66516_ParseContextUsage() throws Exception {
        ...
        try {
            ...
            String result = content.toString();
            assertFalse("CVE-2025-66516: ParseContext.getXMLInputFactory() must not leak file contents via XXE", result.contains("root:") || result.contains("daemon:"));
        } catch (Exception e) {
            // Expected - XXE should be blocked
            String msg = e.getMessage();
            assertTrue("CVE-2025-66516: ParseContext infrastructure-level XXE protection failed, got: " + msg, msg != null && (msg.contains("entity") || msg.contains("DTD") || msg.contains("not declared")));
        }
    }
    ...
    public void testCVE_2025_66516_CustomParserPattern() throws Exception {
        ...
        try {
            ...
            assertFalse("CVE-2025-66516: Custom parser implementation must not leak file contents via XXE", result.contains("root:") || result.contains("daemon:"));
            ...
            if (msg != null && e.getCause() != null) {
                ...
                assertTrue("CVE-2025-66516: Custom parser XXE protection failed, got: " + msg + " cause: " + causeMsg, causeMsg != null && (causeMsg.contains("entity") || causeMsg.contains("DTD") || causeMsg.contains("not declared")));
            } else {
                assertTrue("CVE-2025-66516: Custom parser XXE protection failed, got: " + msg, msg != null && (msg.contains("XXE blocked") || msg.contains("entity") || msg.contains("processing")));
            }
        }
    }
    ...
    public void testCVE_2025_66516_DirectApplicationUsage() throws Exception {
        ...
        try {
            ...
            String result = content.toString();
            assertFalse("CVE-2025-66516: Direct application usage of XMLReaderUtils must not leak file contents via XXE", result.contains("root:") || result.contains("daemon:"));
        } catch (Exception e) {
            // Expected - XXE should be blocked
            String msg = e.getMessage();
            assertTrue("CVE-2025-66516: XXE protection failed in direct application code usage, got: " + msg, msg != null && (msg.contains("entity") || msg.contains("DTD") || msg.contains("not declared")));
        }
    }
